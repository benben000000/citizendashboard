...
print("=========================================================================================================")
print(f"   [ITERATION 2/4 AUDIT] FULL NETWORK METEOROLOGICAL COMPARISON MATRIX @ {pht_str}")
print("=========================================================================================================")
...
for s in raw_stations:
    ...
    if sid == "1Zb102pg" and raw_pres and raw_pres < 1000.0:
        proc_pres = raw_pres + 6.5
