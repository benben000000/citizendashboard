...
export const fil = {
  ...
  prediction: {
    ...
    cards: {
      ...
      moderateRisk: "Katamtamang Panganib",
      highHumidity: "Mataas ang Alinsangan",
      dryAir: "Tuyo ang Hangin",
      normalHumidity: "Katamtamang Alinsangan",
      uvVeryHigh: "Napakataas / Maglilim",
    ...
    peakSection: {
      ...
      burstTitle: "Bubuhos ba ang Ulan? (Payong & Kapote)",
      burstSubtitle: "Kailangan mo bang magbaon ng payong ngayong araw?",
      leadHorizonTitle: "Oras ng Prediksyon (Lead Horizon)",
      leadHorizonSubtitle: "Dynamic na pagtatantiya sa susunod na mga oras",
      burstTypes: {
        sudden_heavy: "Babala sa Malakas na Ulan",
        short_burst_heavy: "Maikling Bugso ng Malakas na Buhos",
        sudden_light: "Mahinang Pag-ambon",
        short_burst_light: "Maikling Bugso ng Mahinang Ulan",
        none: "Walang Biglaang Ulan",
      },
      burstBadges: {
        sudden_heavy: "Malakas na Ulan",
        short_burst_heavy: "Malakas na Bugso",
        sudden_light: "Mahinang Ambon",
        short_burst_light: "Pag-ambon",
        none: "Maliwanag",
      },
      burstLabels: {
        rate: "Tindi ng Buhos",
        ...
        minutes: "{min} minuto",
        stable: "Kalmado ang panahon. Walang inaasahang buhos ng ulan.",
      },
    },
  },
  terminology: {
