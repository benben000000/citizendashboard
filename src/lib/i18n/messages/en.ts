export const en = {
    ...
    prediction: {
      ...
      peakSection: {
        crestTitle: "Peak Water Level Forecast",
        crestSubtitle: "Maximum projected river stage across continuous lead horizon",
        ...
        burstTitle: "Sudden Rain & Convective Burst Nowcast",
        burstSubtitle: "Radar & satellite micro-burst prediction",
        leadHorizonTitle: "Forecast Lead Horizon",
        leadHorizonSubtitle: "Dynamic continuous-time ODE projection timeframe",
        burstTypes: {
          sudden_heavy: "Sudden Heavy Rain Detected",
          short_burst_heavy: "Short Burst of Heavy Downpour",
          sudden_light: "Sudden Light Rain Showers",
        ...
        burstLabels: {
          ...
          onset: "Expected Onset",
          radar: "Doppler Radar",
          cloud: "Convective Index",
          minutes: "{min} mins",
          stable: "Atmospheric column is stable. Normal diurnal conditions.",
        },
      },
    },
    terminology: {
